...
GROUP_CONCAT(DISTINCT CONCAT(c.name, ': ',
		(SELECT GROUP_CONCAT(f.title ORDER BY f.title SEPARATOR ', ')
                    FROM MovieRental.film f
                    INNER JOIN MovieRental.film_category fc
                      ON f.film_id = fc.film_id
                    INNER JOIN MovieRental.film_actor fa
...
AS film_info
FROM MovieRental.actor a
LEFT JOIN MovieRental.film_actor fa
  ON a.actor_id = fa.actor_id
LEFT JOIN MovieRental.film_category fc
  ON fa.film_id = fc.film_id
LEFT JOIN MovieRental.category c
